...
import * as React from 'react';
import { styled, alpha } from '@mui/material/styles';
import { Drawer, List, ListItem, ListItemText, IconButton, Toolbar, AppBar, Box, Typography, InputBase, Badge, MenuItem, Menu } from '@mui/material';
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Drawer anchor="left" open={drawerOpen} onClose={toggleDrawer(false)}>
        <List>
          ...
          <ListItem button component={Link} to="/nurse-addition">
            <ListItemText primary="Nurse Addition" />
          </ListItem>
          <ListItem button component={Link} to="/nurse-login">
            <ListItemText primary="Nurse Login" />
          </ListItem>
          ...
          <ListItem button component={Link} to="/patient-medical-records">
            <ListItemText primary="Patient Medical Records" />
          </ListItem>
          <ListItem button component={Link} to="/medical-tests">
            <ListItemText primary="Medical Tests" />
          </ListItem>
          <ListItem button component={Link} to="/patient-medical-tests">
            <ListItemText primary="Patient Medical Tests" />
          </ListItem>
          <ListItem button component={Link} to="/All-patient-medicine">
            <ListItemText primary="All Patient Medicine" />
          </ListItem>
          <ListItem button component={Link} to="/single-patient-medicine">
            <ListItemText primary="Single Patient Medicine" />
          </ListItem>
          <ListItem button component={Link} to="/specific-patient-medicine">
            <ListItemText primary="Specific Patient Medicine" />
          </ListItem>
          <ListItem button component={Link} to="/specific-patient-record">
            <ListItemText primary="Specific Patient Record" />
          </ListItem>
          <ListItem button component={Link} to="/specific-patient-test">
            <ListItemText primary="Specific Patient Test" />
          </ListItem>
          <ListItem button component={Link} to="/delete-patient-medicine">
            <ListItemText primary="Delete Patient Medicine" />
          </ListItem>
          <ListItem button component={Link} to="/delete-patient-record">
            <ListItemText primary="Delete Patient Record" />
          </ListItem>
          <ListItem button component={Link} to="/delete-patient-test">
            <ListItemText primary="Delete Patient Test" />
          </ListItem>
          <ListItem button component={Link} to="/add-patient-medicine">
            <ListItemText primary="Add Patient Medicine" />
          </ListItem>
          <ListItem button component={Link} to="/add-patient-test">
            <ListItemText primary="Add Patient Test" />
          </ListItem>
          <ListItem button component={Link} to="/add-patient-record">
            <ListItemText primary="Add Patient Record" />
          </ListItem>
          <ListItem button component={Link} to="/update-nurse">
            <ListItemText primary="Update Nurse" />
          </ListItem>
          <ListItem button component={Link} to="/update-patient">
...
import * as React from 'react';
import { styled, alpha } from '@mui/material/styles';
import { Drawer, List, ListItem, ListItemText, IconButton, Toolbar, AppBar, Box, Typography, Badge, MenuItem, Menu } from '@mui/material';
import { Link } from 'react-router-dom';
import MenuIcon from '@mui/icons-material/Menu';
import AccountCircle from '@mui/icons-material/AccountCircle';
import MailIcon from '@mui/icons-material/Mail';
...
export default function PrimarySearchAppBar() {
  ...
  const renderMenu = (
    ...
    >
      ...
      <MenuItem component={Link} to="/login" onClick={handleMenuClose}>My account</MenuItem>
    </Menu>
  );
    ...
    <Box sx={{ flexGrow: 1 }}>
      ...
      <Drawer anchor="left" open={drawerOpen} onClose={toggleDrawer(false)}>
        <List>
          ...
          <ListItem button component={Link} to="/nurse-profile">
            <ListItemText primary="Nurse Profile" />
          </ListItem>
          <ListItem button component={Link} to="/nurse-addition">
            <ListItemText primary="Nurse Addition" />
          </ListItem>
...
function Appbar() {
  const [anchorElNav, setAnchorElNav] = React.useState(null);
  const [anchorElUser, setAnchorElUser] = React.useState(null);
  const [anchorElCall, setAnchorElCall] = React.useState(null);
  const [anchorEl, setAnchorEl] = React.useState(null);
const [mobileMoreAnchorEl, setMobileMoreAnchorEl] = React.useState(null);
const [drawerOpen, setDrawerOpen] = React.useState(false);
