    ...
    <Box sx={{ margin: '0 30px' }}>
      <Container>
        <Paper elevation={3} style={paperStyle}>
          ...
          >
            {sessionID ? (
          <p>Click find to see medical test</p>
        ) : (
          <p>No session ID available. Please log in.</p>
        )}
        <div style={{ marginBottom: '20px' }}></div>
          ...
          <Table>
            <TableHead>
              ...
              <TableCell>Patient ID</TableCell>
                ...
                <TableCell>Insulin</TableCell>
                <TableCell>BMI</TableCell>
                <TableCell>Chances of Diabetes</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {tests.map((test) => (
                <TableRow key={test.s_no}>
                  ...
                  <TableCell>{test.bmi || 'Not available'}</TableCell>
                  <TableCell>
        {test.outcome !== undefined && test.outcome !== null 
          ? test.outcome === 0 
            ? 'No chances of diabetes' 
            : 'Chances of diabetes are present' 
          : 'Not available'}
      </TableCell>
                </TableRow>
              ))}
